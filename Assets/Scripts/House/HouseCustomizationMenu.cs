...
public class HouseCustomizationMenu : MonoBehaviour
{
    ...
    [SerializeField] private HouseInformationLoader uiLoader = null;
    ...
    private HouseInformation houseInfo = new HouseInformation();
    ...
    {
        //Set house part info
        houseInfo.housePartToSprite[index] = sprite;

        //Refresh UI
        uiLoader.LoadInformation(houseInfo);
    }

    public void CreateButtonPressed()
    {
        UIPanelsManager.Instance.CloseCurrentPanel();
        PlayerStateMachine.Instance.TrySwitchState<PlaceHouseState>(new object[] { houseInfo });
    }
}
